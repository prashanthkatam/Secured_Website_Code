...
class script{
        ...
        public function __construct(){
                ...
                $server = "mysqldb2022.ci7gtzzbdlsp.us-west-2.rds.amazonaws.com";
                $user = "admin";
                $pass = "admin123";
                $db = "customers";
        ...
        public function add($fname,$lname,$mobileno,$city,$date,$dob,$bloodgroup){
                $sql = "insert into donors(fname,lname,mobileno,city,date,dob,bloodgroup) values('".urlencode($fname)."','".urlencode($lname)."','".urlencode($mobileno)."','".urlencode($city)."','".urlencode($date)."','".urlencode($dob)."','".urlencode($bloodgroup)."')";
...
<button type="submit" formaction="/index.html" style="background: grey; height: 45px; width: 200px; color:white; font:oblique;">Redirect to home page</button><br><br>
			  ...
			  <form method="post">
        <p>FName: <input type="text" name="fname" required></p>
        <p>LName: <input type="text" name="lname" required></p>
       
        <p>MobileNo: <input name="mobileno"
    ...
    maxlength = "10"
		...
		<p>DOB: <input type="date" name="dob" required></p>
		 <p>Blood Group   <select name = "bloodgroup" required>Blood Group
...
$script = new script();
if(isset($_POST['sub'])){
        $script->add($_POST['fname'],$_POST['lname'],$_POST['mobileno'],$_POST['city'],$_POST['date'],$_POST['dob'],$_POST['bloodgroup']);
}
?>
